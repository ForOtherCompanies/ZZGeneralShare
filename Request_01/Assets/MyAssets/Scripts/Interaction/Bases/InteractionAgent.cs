...
//4-acting -> to perform inner actions (MakeActions) (continuous and repeat while acting == true)
...
*/
	...
	public virtual void InitAction(){
		...
		readyToAct = false;
		activationTimer = 0;
		Debug.Log (transform.name + " Init action from base interaction agent");
	...
	public virtual void MakeActions (){
		...
		Debug.Log (transform.name + " make actions from base interaction agent");
	//	acting = false;
		EndAction ();
